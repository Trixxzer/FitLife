...
// FitLife Trainer tab — dark UI + orange accents (matches your home style)
          ...
          <View style={{ flexDirection: "row", gap: 10, paddingRight: 6 }}>
            {chips.map((c) => {
              ...
              return (
                ...
                >
                  <Text style={{ color: active ? "#FFD3CA" : MUTED, fontWeight: "900", fontSize: 12 }}>
                    {c}
                  </Text>
                </TouchableOpacity>
              );
          ...
          <View style={[styles.card, { marginTop: 14 }]}>
            ...
            <View style={{ flexDirection: "row", gap: 12, marginTop: 12, alignItems: "center" }}>
              <View style={styles.avatarBig}>
                {/* Replace with real Image when you have profile urls */}
                <Image
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ color: "#AEB8CA", marginTop: 8, fontSize: 12, lineHeight: 16 }}>
                  {featured.bio}
                </Text>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row", gap: 10, marginTop: 14 }}>
              ...
              <TouchableOpacity activeOpacity={0.9} style={[styles.btnSolid, { flex: 1 }]}>
                <Text style={{ color: "white", fontWeight: "900" }}>
                  Hire • ${featured.pricePerMonth}/mo
                </Text>
              </TouchableOpacity>
            </View>
          </View>
                ...
                <View style={{ flexDirection: "row", gap: 12 }}>
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginTop: 8 }}>
                      ...
                      <Text style={{ color: "#AEB8CA", fontSize: 12, marginLeft: "auto" }}>
                        ${t.pricePerMonth}/mo
                      </Text>
                    </View>
                    ...
                    <View style={{ flexDirection: "row", gap: 10, marginTop: 12 }}>
                      ...
                      <TouchableOpacity activeOpacity={0.9} style={[styles.btnSolid, { flex: 1, height: 42 }]}>
  ...
  return (
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      {Array.from({ length: 5 }).map((_, i) => {
        const idx = i + 1;
        const name =
          idx <= full ? "star" : idx === full + 1 && half ? "star-half" : "star-outline";
...
const styles = {
  ...
  badgeText: { color: "#FFD3CA", fontWeight: "900" as const, fontSize: 11 },
